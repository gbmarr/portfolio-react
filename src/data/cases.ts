...
export const cases: CaseStudy[] = [
  {
    ...
    work: 'Desarrollé la app completa: sistema de puntajes, login con Google y pagos con Mercado Pago.',
  ...
  },
  {
    ...
    work: 'Me integré al equipo para resolver bugs, ajustar el funcionamiento e integrar el login con Google.',
